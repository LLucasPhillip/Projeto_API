...
@professor_blueprint.route('/criar', methods=['POST'])
def criar_prof():
...
@professor_blueprint.route('/<int:id_professor>', methods=['GET'])
...
@professor_blueprint.route('/<int:id_professor>/editar', methods=['GET'])
...
@professor_blueprint.route('/api', methods=['POST'])
...
@professor_blueprint.route('/api/<int:id_professor>', methods=['PUT'])
...
@professor_blueprint.route('/api/<int:id_professor>', methods=['DELETE'])
